        ...
        <div className={"flex w-full"}>
            <Link href={`/project/${id + 1}`}
                ...
                <div className={"relative z-20 overflow-hidden text-center"}>
                    ...
                    <p className={"md:group-hover:-translate-y-2 md:group-hover:text-white transition-transform duration-500 text-4xl md:text-7xl"}>Woota</p>
                    <div
                        className={"absolute bottom-0 -left-full md:group-hover:translate-x-full transition-transform duration-500 w-full h-1 bg-white"}></div>
                </div>
                <div
                    className={"absolute md:group-hover:opacity-0 transition-opacity duration-500 z-10 top-0 w-full h-full bg-white"}></div>
            ...
            <Link href={`/project/${id + 1}`}
                ...
                <div className={"relative z-20 overflow-hidden text-center"}>
                    ...
                    <p className={"md:group-hover:-translate-y-2 md:group-hover:text-white transition-transform duration-500 text-4xl md:text-7xl"}>Title</p>
                    <div
                        className={"absolute bottom-0 -left-full md:group-hover:translate-x-full transition-transform duration-500 w-full h-1 bg-white"}></div>
                </div>
                <div
